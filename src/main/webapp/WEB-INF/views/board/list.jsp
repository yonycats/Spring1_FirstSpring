					...
					<div class="card-body mt-3">
						...
						<div class="mt-2">
							<table class="table">
								...
								<tbody>
									<!--
										EL표현문 안에서는 getDataList()에서 
										get이 날라가고 / 대문자(D)가 소문자(d)로 변경되고 / ()가 날라감
										=> dataList
									-->
...
<script>
$(function() {
	let pagingArea = $("#pagingArea"); // 페이징이 들어있는 div 영역
	let searchForm = $("#searchForm"); // 검색과 페이징의 submit 이벤트를 담당할 form
	
	// 페이지 번호를 눌렀을 때 submit 이벤트가 발생해야 함
	// pagingArea 안에 들어있는 (ul과 li 안에 들어있는) a라는 태그를 클릭했을 때의 이벤트
	pagingArea.on("click", "a", function(event) {
		event.preventDefault();
		// 사용자 정의 속성 불러오기
		// <li class = 'page-item'><a href ='' class='page-link' data-page=''></a></li>
		// 자바스크립트 : this.dataset.page;
		// 제이쿼리 : $(this).data("page");
		let pageNo = $(this).data("page"); // $(this) : 방금 클릭한 a => this에 dataset을 가져옴
