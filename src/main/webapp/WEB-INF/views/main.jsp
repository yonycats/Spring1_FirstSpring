	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체  ${pagingVOBoard.totalRecord }건</span>
				</div>
			...
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체  ${pagingVONotice.totalRecord }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div align="right">
					<span class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill">전체 ${pagingVOFree.totalRecord }건</span>
				</div>
				<form action="" method="post">
					<div style="padding-top: 50px">
						<table class="table">
